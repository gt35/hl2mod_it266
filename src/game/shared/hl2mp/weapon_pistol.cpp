...
#include "c_te_effect_dispatch.h"
	...
	#include "te_effect_dispatch.h"//gt35 include added for explosion

#endif

#include "weapon_hl2mpbasehlmpcombatweapon.h"
#include "weapon_hl2mpbase_machinegun.h"
#include "effect_dispatch_data.h" //gt35 added this include for custom impact effects
#define	PISTOL_FASTEST_REFIRE_TIME		0.1f
#define	PISTOL_FASTEST_DRY_REFIRE_TIME	0.2f

#define	PISTOL_ACCURACY_SHOT_PENALTY_TIME		0.0f	// Applied amount of time each shot adds to the time we must recover from
#define	PISTOL_ACCURACY_MAXIMUM_PENALTY_TIME	0.0f	// Maximum penalty to deal out
...
public:
	...
	void	DryFire( void );
	void	DoImpactEffect( trace_t &tr, int nDamageType );//gt35
	...
	{		
		...
		VectorLerp( VECTOR_CONE_1DEGREES, VECTOR_CONE_1DEGREES, ramp, cone );//gt35 changed recoil
...
// Output : int
//-----------------------------------------------------------------------------
Activity CWeaponPistol::GetPrimaryAttackActivity( void )//gt35 also change recoil here
{
